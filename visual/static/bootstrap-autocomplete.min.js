!(function (t) {
    ...
    s.m = t, s.c = e, s.d = function (t, e, i) {
        ...
        if (s.r(i), Object.defineProperty(i, 'default', {
            enumerable: !0,
            value: t,
        }), 2 & e && typeof t !== 'string') { for (var o in t) { s.d(i, o, function (e) {
            return t[e]
        }.bind(null, o)); } }
        return i
    }, s.n = function (t) {
    ...
    var i, o = (i = function (t, e) {
        ...
        i(t, e), t.prototype = e === null ? Object.create(e) : (s.prototype = e.prototype, new s)
    }), n = (function (t) {
        function e(e) {
        ...
        return o(e, t), e.prototype.getDefaults = function () {
            ...
            var s = this;
            this.jqXHR != null && this.jqXHR.abort();
            var i = {};
            i[this._settings.queryKey] = t, $.extend(i, this._settings.extraData), this.requestTID && window.clearTimeout(this.requestTID), this.requestTID = window.setTimeout(function () {
                s.jqXHR = $.ajax(s._settings.url, {
                    ...
                    var e;
                    (e = s._settings) === null || void 0 === e || e.fail(t)
        ...
        return t.prototype.init = function () {
            ...
            if (this.haveResults) {
                ...
                s.length === 0 && (s = t ? this._dd.find('li').last() : this._dd.find('li').first()), e.removeClass('active'), s.addClass('active')
            }
            ...
            get: function () {
                return Boolean(this.isShown() && this._dd.find('li.active').length > 0)
            }, enumerable: !1, configurable: !0,
            ...
            if (this.items.length > 0) { this.items.forEach(function (s) {
                ...
                typeof n === 'string' && (n = {text: n}), i = t.showMatchedText(n.text, t.searchText), o = void 0 !== n.html ? n.html : i;
        ...
        return t.prototype.getElPos = function () {
            ...
            if (this.haveResults) {
                ...
                s.length === 0 && (s = t ? this._dd.find('.dropdown-item').last() : this._dd.find('.dropdown-item').first()), e.removeClass('active'), s.addClass('active')
            }
        }, t.prototype.focusPreviousItem = function () {
            this.focusNextItem(!0)
        }, t.prototype.selectFocusItem = function () {
            ...
            get: function () {
                return Boolean(this._dd && this.isShown() && this._dd.find('.dropdown-item.active').length > 0)
            }, enumerable: !1, configurable: !0,
        }), t.prototype.show = function () {
            if (!this.shown) {
                this.getElPos();
        ...
        function t(t, e) {
            ...
            }, this._el = t, this._$el = $(this._el), this._$el.is('select') && (this._isSelectElement = !0), this.manageInlineDataAttributes(), typeof e === 'object' && (this._settings = $.extend(!0, {}, this.getSettings(), e)), this._isSelectElement && this.convertSelectToText(), this.init()
        }
        ...
        return t.prototype.manageInlineDataAttributes = function () {
            ...
            var t;
            this._settings.bootstrapVersion === 'auto' ? t = $.fn.button.Constructor.VERSION.split('.').map(parseInt) : this._settings.bootstrapVersion === '4' ? t = [4] : this._settings.bootstrapVersion === '3' ? t = [3] : (console.error("INVALID value for 'bootstrapVersion' settings property: " + this._settings.bootstrapVersion + ' defaulting to 4'), t = [4]);
            return t
            ...
            this.bindDefaultEventListeners(), this._settings.resolver === 'ajax' && (this.resolver = new n(this._settings.resolverSettings)), this.getBootstrapVersion()[0] === 4 ? this._dd = new l(this._$el, this._settings.formatResult, this._settings.autoSelect, this._settings.noResultsText) : this._dd = new r(this._$el, this._settings.formatResult, this._settings.autoSelect, this._settings.noResultsText)
            ...
            this._$el.on('keydown', function (e) {
                ...
                !t._dd.isMouseOver && t._dd.isDdMouseOver && t._dd.isShown() ? (setTimeout(function () {
                    t._$el.focus()
                }), t._$el.focus()) : t._dd.isMouseOver || (t._isSelectElement ? t._dd.isItemFocused ? t._dd.selectFocusItem() : t._selectedItem !== null && t._$el.val() !== '' ? t._$el.trigger('autocomplete.select', t._selectedItem) : t._$el.val() !== '' && t._defaultValue !== null ? (t._$el.val(t._defaultText), t._selectHiddenField.val(t._defaultValue), t._selectedItem = null, t._$el.trigger('autocomplete.select', t._selectedItem)) : (t._$el.val(''), t._selectHiddenField.val(''), t._selectedItem = null, t._$el.trigger('autocomplete.select', t._selectedItem)) : t._selectedItem === null && t._$el.trigger('autocomplete.freevalue', t._$el.val()), t._dd.hide())
            ...
            (this._settings.events.typed === null || (t = this._settings.events.typed(t, this._$el))) && (t.length >= this._settings.minLength ? (this._searchText = t, this.handlerPreSearch()) : this._dd.hide())
            ...
            var t = this;
            this._settings.events.search !== null ? this._settings.events.search(this._searchText, function (e) {
            ...
            this._settings.events.searchPost && typeof (t = this._settings.events.searchPost(t, this._$el)) === 'boolean' && !t || this.handlerStartShow(t)
            ...
            if (t != null) {
                ...
                typeof e === 'string' && (e = {text: e}), this._$el.val(e.text), this._isSelectElement && this._selectHiddenField.val(e.value)
            ...
            return typeof t === 'string' ? {text: t} : t.text ? t : {text: t.toString()}
        }, t.prototype.manageAPI = function (t, e) {
            t === 'set' ? this.itemSelectedDefaultHandler(e) : t === 'clear' ? this.itemSelectedDefaultHandler(null) : t === 'show' ? this._$el.trigger('keyup') : t === 'updateResolver' && (this.resolver = new n(e))
